                    ...
                    VStack{
                        ZStack{
                            ...
                            VStack(alignment: .leading){
                                ...
                                Divider().frame(width: 390)
                                TransactionView(transPic: "SteamIcon", transName: "www.steampowered.com", transDate: "22 Nov - Automatic payment")
                                Divider().frame(width: 390)
                                TransactionView(transPic: "Nintencon", transName: "Nintendo", transDate: "20 Nov - Automatic payment")
                                Divider().frame(width: 390)
                                Text("Show all")
                                    .font(.headline)
